...
class LRSchedulerModule:
    def __init__(self):
        self.MultiStepRestartLR = MultiStepRestartLR
        self.LinearLR = LinearLR
        self.VibrateLR = VibrateLR
        self.CosineAnnealingRestartLR = CosineAnnealingRestartLR
        self.CosineAnnealingRestartCyclicLR = CosineAnnealingRestartCyclicLR

# Create singleton instance
lr_scheduler = LRSchedulerModule()
