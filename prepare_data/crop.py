...
if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description="Crop images to ≤ max_pixels")
    parser.add_argument("--input-dir",        required=True, help="Directory of HQ source images")
    parser.add_argument("--depth-dir",        required=True, help="Directory of corresponding depth maps")
    parser.add_argument("--output-dir",       required=True, help="Output directory for cropped HQ images")
    parser.add_argument("--output-depth-dir", required=True, help="Output directory for cropped depth maps")
    parser.add_argument("--max-pixels",       type=int, default=1_000_000)
    args = parser.parse_args()

    process_folder(args.input_dir, args.depth_dir, args.output_dir, args.output_depth_dir, max_pixels=args.max_pixels)
